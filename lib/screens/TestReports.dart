...
class ShowMoreCards extends StatefulWidget {
  const ShowMoreCards({Key key}) : super(key: key);

  @override
  ShowMoreCardsState createState() => ShowMoreCardsState();
}

class ShowMoreCardsState extends State<ShowMoreCards> {
  List<CardsData> postsList = [];
  final reference = FirebaseDatabase.instance.reference().child("User Data").child(FirebaseAuth.instance.currentUser.uid).child("Test Reports");
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: new AppBar(
          title: new Text("Previous Test Data"),
        ),
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              ...
              Text('$testValue'+ 'ng/ml',style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.bold),),
            ],
          ),
          SizedBox(height: 10,),
          Row(
